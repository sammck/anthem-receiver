...
from ..protocol import AnthemModel, anthem_models
        ...
        """Creates a configuration for a Anthem receiver client.
           ...
           Args:
             default_host: The default hostname or IPV4 address of the receiver.
                   ...
                   May be "dp://" or "dp://<device-name>" to use
             ...
             default_port: For TCP/IP transports, the default TCP/IP port number to use.
                    ...
                    environment variable. If that environment variable is not found, the default Anthem
             ...
             model:
                   The known receiver model. If None, the model will be
